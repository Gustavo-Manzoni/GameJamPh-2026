...
public class DialogueSystem : MonoBehaviour
{
    ...
    private System.Action onDialogueStartCallback;
    private System.Action onDialogueFinishCallback;
    ...
    public bool StartDialogue(string[] lines, System.Action onStart = null, System.Action onFinish = null)
    {
        if (IsDialogueActive)
        {
            return false;
        ...
        currentLines = lines;
        currentLineIndex = -1;
        onDialogueStartCallback = onStart;
        onDialogueFinishCallback = onFinish;

        IsDialogueActive = true;
        onDialogueStartCallback?.Invoke();
    ...
    private void EndDialogue()
    {
        ...
        System.Action callback = onDialogueFinishCallback;
        onDialogueStartCallback = null;
        onDialogueFinishCallback = null;
        callback?.Invoke();
    }
